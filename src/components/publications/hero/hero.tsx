...
const Hero = () => {
  return (
    <div className="pb-20 pt-36 max-h-[100vh]">
      ...
      {/* Grid background with dark theme enforced */}
      <div className="h-screen w-full dark:bg-black-100 dark:bg-grid-white/[0.03] absolute top-0 left-0 flex items-center justify-center">
        {/* Radial gradient to blend in with the dark background */}
      ...
      <div className="flex justify-center relative my-20 z-10">
        <div className="max-w-[89vw] md:max-w-7xl lg:max-w-7xl flex flex-col items-center justify-center">
          ...
          {/* TextGenerateEffect with responsive text sizes */}
          <TextGenerateEffect
            words="Transforming Concepts into Seamless User Experiences"
            className="text-center text-[40px] md:text-5xl lg:text-6xl"
          />

          <h1 className="max-w-7xl font-bold bg-gradient-to-br from-white to-gray-400 bg-clip-text text-center text-3xl leading-tight text-transparent sm:text-5xl sm:leading-tight md:text-7xl md:leading-tight">
